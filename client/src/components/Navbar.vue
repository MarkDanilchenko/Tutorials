      ...
      <div class="container-fluid mt-3">
        ...
        <div id="navbarContent" class="collapse navbar-collapse">
          <ul class="navbar-nav me-auto">
            ...
            <li class="nav-item">
              <router-link to="/tutorials" class="nav-link" :class="{ 'nav-link-active': $route.path == '/tutorials' }"
          ...
          <div class="d-flex justify-content-center align-items-center">
            ...
            <button
              v-if="!isSignedIn"
              class="btn me-1"
              :class="$route.path == '/signin' ? 'btn-green-custom' : 'btn-outline-green-custom'"
              type="button"
            ...
            <button
              v-if="!isSignedIn"
              class="btn me-1"
              :class="$route.path == '/signup' ? 'btn-green-custom' : 'btn-outline-green-custom'"
              type="button"
              @click="$router.push('/signup')"
            >
              SignUp
            </button>
            <button v-if="isSignedIn" class="btn btn-outline-secondary me-1" type="button" @click.prevent="signOut">
              SignOut
            </button>
          </div>
          <!-- colorMode_switcher -->
          <div class="mt-3 mt-md-0 d-flex flex-column align-items-center justify-content-center">
            <input id="colorMode_switcher" type="checkbox" @change="changeColorMode" />
