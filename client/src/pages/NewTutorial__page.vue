                ...
                <form action="" class="col-lg-6 col-md-8 col-10" name="addNewTutorial__form" id="addNewTutorial__form">
                    <fieldset class="form-group mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div v-if="v$.form.description.required.$invalid" class="text-secondary text-small">This field is
                                required.</div>
                            <div v-if="v$.form.description.maxLength.$invalid" class="text-danger text-small">Description should
